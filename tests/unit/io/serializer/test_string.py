...
def test_string_latin1_serializer_many():
    ...
    deserialized_messages: List[str] = string_serializer.deserialize_many(raw_messages)
    assert deserialized_messages == expected_deserialized_messages
    serializer_messages: List[bytes] = string_serializer.serialize_many(deserialized_messages)
